...
import { usePortfolioQuery } from '../hooks/useDefiDash';

export function PortfolioPage() {
  const { rows, summary, isLoading, isError } = usePortfolioQuery();
              ...
              <div className={styles.metricsGroup}>
                ...
                <div className={styles.healthBox}>
                  ...
                  >
                    ...
                    <span className={styles.healthValue}>{calculatedHealthFactor.toFixed(2)}</span>
                  </div>
                    ...
                    <div className={styles.assetInfo} style={{ flex: 1.5 }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <span className={styles.assetSymbol}>
                          ${formatNumber(asset.borrowedUsd)}
                        </span>
                      </div>
                    </div>
                    <div className={styles.assetApy} style={{ flex: 1 }}>
